...
if (!isset($_SESSION['user_id']) || $_SESSION['rol'] !== 'admin_general') {
...
<head>
    ...
    <title>Panel de Admin General</title>
    <link rel="stylesheet" href="../../styles/administrators/admin_dashboard.css?v=<?= time(); ?>">
</head>
<body>
    <header>
        <h1>Panel de Control - Admin General</h1>
        <div class="user-menu">
            <span><?= htmlspecialchars($_SESSION['nombre']) ?> (Admin General)</span>
